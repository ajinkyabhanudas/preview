.DEFAULT_GOAL := help
.PHONY: help install lint typecheck test test-property test-leak test-determinism check build clean gates
...
gates: check test-property test-leak test-determinism ## Every release gate. Must pass before merge.
